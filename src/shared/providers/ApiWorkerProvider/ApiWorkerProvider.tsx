...
//const apiWorker = new Worker(new URL("worker:../../workers/api/api.worker.ts", import.meta.url));
//import w from "../../workers/api/api.worker"
//import Worker from "../../workers/api/api.worker.ts";
...
const addToQueue = (callback: (data: unknown) => void, id: string | number, data: unknown) => {
  ...
  //setTaskQueue((queue) => ({ ...queue, [id]: { callback, id } }));
}
